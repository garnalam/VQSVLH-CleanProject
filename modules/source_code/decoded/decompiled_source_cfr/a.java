...
public final class a {
    ...
    private static byte[] a(byte[] byArray) {
        ...
        while (n4 < n2) {
            int n6 = n5;
            byArray2[n6] = (byte)(byArray2[n6] | a.a(byArray[n4]));
            int n7 = n5++;
            byArray2[n7] = (byte)(byArray2[n7] | a.a(byArray[n4 + 1]) << 4);
            n4 += 2;
        }
        return byArray2;
    }
    ...
    public static void a(MIDlet mIDlet) {
        ...
        if (object3 == null) {
            try {
                ...
                object = a.b((byte[])object3);
                stringArray = a.a((String)object, String.valueOf('\n'));
        ...
        byte[] byArray = a.a((byte[])object);
        object = byArray;
        a.a(byArray, (byte[])object2);
        ...
        object3 = a.b((byte[])object);
        String[] stringArray2 = a.a((String)object3, "|");
        ...
        int n5 = 0;
        while (n5 < n2) {
            a.d[n5] = stringArray2[n5 + 1];
            a.f[n5] = Integer.parseInt(stringArray2[n5 + n2 + 1]);
            a.e[n5] = stringArray2[n5 + n2 + n2 + 1];
            ++n5;
        }
        c = new String[n2];
        if (bl) {
            n5 = 0;
            while (n5 < n2) {
                a.c[n5] = mIDlet.getAppProperty("sr" + (n5 + 1));
                ++n5;
            }
            return;
        }
