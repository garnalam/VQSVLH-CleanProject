...
final class Scene1Room3EntryScript {
    ...
    static void appendTo(List<Event> e) {
            ...
            e.add(s -> { VqsvSceneScriptSupport.setActive(s, new int[]{48, 49, 50}, new int[]{1, 2, 2}); return null; });
            e.add(s -> new CameraPan(49, 0));
            e.add(s -> new Delay(15));
            e.add(s -> new CameraPan(48, 10));
            e.add(VqsvSceneScriptSupport.dialog(VqsvText.Scene1Room0Group0.NEIL, VqsvText.Scene1Room3BeforeTenYears.TEXT[1]));
            ...
            e.add(s -> new Delay(15));
            e.add(VqsvSceneScriptSupport.dialog("Sophie", VqsvText.Scene1Room3BeforeTenYears.TEXT[2]));
            ...
            e.add(VqsvSceneScriptSupport.dialog("Neil", VqsvText.Scene1Room3BeforeTenYears.TEXT[3]));
            e.add(s -> { s.spawnActorEffect(49, 7); return null; });
            e.add(s -> new ActionSet(new int[]{49, 50}, new int[]{0, 0}, new int[]{0, 0}));
            e.add(VqsvSceneScriptSupport.dialog("Sophie", VqsvText.Scene1Room3BeforeTenYears.TEXT[4]));
            e.add(VqsvSceneScriptSupport.dialog("Neil", VqsvText.Scene1Room3BeforeTenYears.TEXT[5]));
            e.add(VqsvSceneScriptSupport.dialog("Sophie", VqsvText.Scene1Room3BeforeTenYears.TEXT[6]));
            ...
            e.add(VqsvSceneScriptSupport.dialog("Neil", VqsvText.Scene1Room3BeforeTenYears.TEXT[7]));
            e.add(s -> new ActionSet(new int[]{49}, new int[]{0}, new int[]{0}));
            e.add(VqsvSceneScriptSupport.dialog("Sophie", VqsvText.Scene1Room3BeforeTenYears.TEXT[8]));
            e.add(s -> { s.spawnActorEffect(48, 8); return null; });
            e.add(VqsvSceneScriptSupport.dialog("Neil", VqsvText.Scene1Room3BeforeTenYears.TEXT[9]));
            e.add(s -> new TimedAction(new int[]{49, 50}, new int[]{2, 2}, new int[]{4, 4}, new int[]{16, 16}));
            e.add(s -> new ActionSet(new int[]{49, 50}, new int[]{0, 0}, new int[]{0, 0}));
            e.add(VqsvSceneScriptSupport.dialog("Sophie", VqsvText.Scene1Room3BeforeTenYears.TEXT[10]));
            e.add(VqsvSceneScriptSupport.dialog("Neil", "..."));
            e.add(VqsvSceneScriptSupport.dialog("Sophie", VqsvText.Scene1Room3BeforeTenYears.TEXT[11]));
            e.add(VqsvSceneScriptSupport.dialog("Neil", VqsvText.Scene1Room3BeforeTenYears.TEXT[12]));
            e.add(VqsvSceneScriptSupport.dialog("Sophie", VqsvText.Scene1Room3BeforeTenYears.TEXT[13]));
            e.add(s -> new Delay(15));
            e.add(s -> new TimedAction(new int[]{48}, new int[]{2}, new int[]{4}, new int[]{10}));
            e.add(VqsvSceneScriptSupport.dialog("Neil", VqsvText.Scene1Room3BeforeTenYears.TEXT[14]));
            e.add(s -> { s.spawnActorEffect(49, 5); return null; });
            e.add(VqsvSceneScriptSupport.dialog("Sophie", VqsvText.Scene1Room3BeforeTenYears.TEXT[15]));
            e.add(VqsvSceneScriptSupport.dialog("Neil", "..."));
            e.add(VqsvSceneScriptSupport.dialog("Sophie", VqsvText.Scene1Room3BeforeTenYears.TEXT[16]));
            e.add(VqsvSceneScriptSupport.dialog("Neil", VqsvText.Scene1Room3BeforeTenYears.TEXT[17]));
            e.add(s -> { s.spawnActorEffect(49, 14); return null; });
            e.add(VqsvSceneScriptSupport.dialog("Sophie", VqsvText.Scene1Room3BeforeTenYears.TEXT[18]));
            e.add(VqsvSceneScriptSupport.dialog("Neil", VqsvText.Scene1Room3BeforeTenYears.TEXT[19]));
            e.add(s -> { VqsvSceneScriptSupport.setActive(s, new int[]{53, 54, 55, 56}, new int[]{0, 0, 0, 0}); return null; });
            ...
            e.add(VqsvSceneScriptSupport.dialog("??", VqsvText.Scene1Room3BeforeTenYears.TEXT[20]));
            e.add(s -> { s.spawnActorEffect(48, 7); return null; });
            e.add(s -> { s.spawnActorEffect(49, 7); return null; });
            e.add(s -> new ActionSet(new int[]{49}, new int[]{2}, new int[]{2}));
            e.add(VqsvSceneScriptSupport.dialog("Neil", VqsvText.Scene1Room3BeforeTenYears.TEXT[21]));
            e.add(s -> new ActionSet(new int[]{49, 50}, new int[]{0, 0}, new int[]{0, 0}));
            ...
            e.add(VqsvSceneScriptSupport.dialog("Sophie", VqsvText.Scene1Room3BeforeTenYears.TEXT[22]));
            e.add(s -> new TimedAction(new int[]{48}, new int[]{2}, new int[]{4}, new int[]{6}));
            e.add(VqsvSceneScriptSupport.dialog("Neil", VqsvText.Scene1Room3BeforeTenYears.TEXT[23]));
            ...
            e.add(VqsvSceneScriptSupport.dialog("Neil", VqsvText.Scene1Room3BeforeTenYears.TEXT[28]));
            e.add(s -> { s.spawnActorEffect(49, 6); return null; });
            e.add(s -> new Delay(15));
            e.add(VqsvSceneScriptSupport.dialog("Sophie", VqsvText.Scene1Room3BeforeTenYears.TEXT[29]));
            e.add(VqsvSceneScriptSupport.dialog("??", VqsvText.Scene1Room3BeforeTenYears.TEXT[30]));
            ...
            e.add(s -> { VqsvSceneScriptSupport.hide(s, new int[]{49, 53, 54, 55, 56}); return null; });
            ...
            e.add(VqsvSceneScriptSupport.dialog("Neil", VqsvText.Scene1Room3BeforeTenYears.TEXT[33]));
            e.add(s -> { s.effect.startIcon("ikon_1", 120, 100, 10); return s.effect::doneOverlay; });
            e.add(VqsvSceneScriptSupport.dialog("Neil", VqsvText.Scene1Room3BeforeTenYears.TEXT[34]));
            e.add(s -> { s.spawnActorEffect(48, 13); return null; });
            e.add(s -> new Delay(15));
            e.add(VqsvSceneScriptSupport.dialog("Neil", VqsvText.Scene1Room3BeforeTenYears.TEXT[35]));
            e.add(s -> { s.effect.startFade(2, 0); return s.effect::doneOverlay; });
            e.add(s -> {
